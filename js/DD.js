var DD = (function () {
    var skills = [
        { 'name': 'Appraise',           'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Balance',            'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Bluff',              'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Climb',              'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'STR' },
        { 'name': 'Concentration',      'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CON' },
        { 'name': 'Craft',              'description': true,  'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Craft',              'description': true,  'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Craft',              'description': true,  'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Decipher Script',    'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Diplomacy',          'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Disable Device',     'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Disguise',           'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Escape Artist',      'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Forgery',            'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Gather Information', 'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Handle Animal',      'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Heal',               'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Hide',               'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Intimidate',         'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Jump',               'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'STR' },
        { 'name': 'Knowledge',          'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Knowledge',          'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Knowledge',          'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Knowledge',          'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Knowledge',          'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Listen',             'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Move Silently',      'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Open Lock',          'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'DEX' },
        { 'name': 'Perform',            'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Perform',            'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Perform',            'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Profession',         'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Profession',         'description': true,  'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Ride',               'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'DEX' },
        { 'name': 'Search',             'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Sense Motive',       'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Sleight of Hand',    'description': false, 'useUntrained': false, 'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Spellcraft',         'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'INT' },
        { 'name': 'Spot',               'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Survival',           'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'WIS' },
        { 'name': 'Swim',               'description': false, 'useUntrained': true,  'armorCheckPenalty': true,  'keyAbility': 'STR' },
        { 'name': 'Tumble',             'description': false, 'useUntrained': false, 'armorCheckPenalty': true,  'keyAbility': 'DEX' },
        { 'name': 'Use Magic Device',   'description': false, 'useUntrained': false, 'armorCheckPenalty': false, 'keyAbility': 'CHA' },
        { 'name': 'Use Rope',           'description': false, 'useUntrained': true,  'armorCheckPenalty': false, 'keyAbility': 'DEX' }
    ];
    ...
    function Skill(params) {
        ...
        this.abilityMod = params.abilityMod || null;
